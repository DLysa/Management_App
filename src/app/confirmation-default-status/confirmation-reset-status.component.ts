...
export class ConfirmationResetStatusComponent {
  ...
  statusTypes: Status[];
  defaultStatusType: Status[]= [{ id:1, name:"TO FIX"} ,{ id:2, name:"TO TESTS"},{ id:3, name:"UNIT TESTS"}, {id:4, name:"FUNCTIONAL TESTS"},{ id:5, name:"MANUAL TESTS"},{ id:6, name:"AUTOMATION TESTS"},{ id:7, name:"READY TO DEPLOY"}];
